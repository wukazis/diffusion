...
class TrainLoop:
    ...
    def _load_optimizer_state(self):
        opt_checkpoint = bf.join(bf.dirname(self.resume_checkpoint), f"opt{self.resume_step:06d}.pt")
    ...
    def run_loop(self):
        ...
        while (
            ...
            self.run_step(batch.to(dist_util.dev()))
    ...
    def run_step(self, batch):
        ...
        for start in range(0, batch_size, self.microbatch):
            ...
            losses = self.flow.training_losses(self.model, micro)
    ...
    def save(self):
        ...
        with bf.BlobFile(bf.join(logger.get_dir(), f"opt{self.step + self.resume_step:06d}.pt"), "wb") as f:
