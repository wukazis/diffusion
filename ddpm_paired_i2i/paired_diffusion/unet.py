...
class PairedUNetModel(UNetModel):
    """
    A UNetModel conditioned on an image of the same spatial size.
    """
    ...
    def forward(self, x, timesteps, cond=None, **kwargs):
        if cond is None:
            raise ValueError("cond image is required for paired image-to-image diffusion")
